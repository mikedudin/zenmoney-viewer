...
A modern, fast, and standalone web dashboard for visualizing and analyzing personal expenses exported from **ZenMoney**.
...
1. Open the ZenMoney app (mobile or web version).
