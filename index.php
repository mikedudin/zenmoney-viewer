...
header("Content-Security-Policy: default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; font-src 'self' data:; img-src 'self' data:; connect-src 'self'; object-src 'none'; base-uri 'self'; frame-ancestors 'none'; form-action 'self'");

// ── 1. API: Data delivery for index.php?api=data ──────────────
  ...
  <div id="app">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="nav">
        ...
        <button class="nav-item active" id="btn-overview" data-action="switch-mode" data-mode="overview">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
          Обзор
        </button>
        <button class="nav-item" id="btn-months" data-action="switch-mode" data-mode="months">
        ...
        <button class="nav-item" id="btn-categories" data-action="switch-mode" data-mode="categories">
    ...
    <div class="import-overlay" id="import-overlay">
      <div class="import-modal">
        ...
        <button class="import-ok-btn" id="import-ok-btn">OK</button>
      </div>
    </div>
    ...
    <main class="main">
      <header class="topbar">
        ...
        <div class="lang-switch" id="lang-switch">
          <button class="lang-switch-btn" id="lang-switch-btn" aria-haspopup="true" aria-expanded="false" title="Язык / Language">
          ...
          <div class="lang-dropdown" id="lang-dropdown" role="menu">
            <button class="lang-item active" data-action="select-lang" data-lang="ru" role="menuitem">
            ...
            <button class="lang-item" data-action="select-lang" data-lang="en" role="menuitem">
              <span class="lang-flag-icon">🇬🇧</span>
